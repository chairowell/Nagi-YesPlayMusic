export default {
  ...
  login: {
    ...
    noticeDesktop: `YesPlayMusic hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      Şifren MD5 şifreleme ile yerel olarak şifrelenir ve daha sonra NetEase Müzik API'sine gönderilir<br />`,
  },
  mv: {
  ...
  settings: {
    ...
    enableDiscordRichPresence: "Discord'da mevcut parçayı göster",
    updater: {
      title: 'Güncellemeler',
      currentVersion: 'Geçerli sürüm: {version}',
      ready: 'GitHub Releases üzerinden yeni imzalı sürümü denetleyin.',
      ...
      installing: 'Güncelleme yüklenince uygulama yeniden başlatılacak.',
      upToDate: 'En son sürümü kullanıyorsunuz.',
      failed: 'Güncelleme tamamlanamadı. Daha sonra yeniden deneyin.',
      unconfigured: 'Geliştirme derlemesinde güncellemeler kullanılamaz.',
    },
    ...
    enableOsdlyricsSupport: {
      ...
      desc: "Linux'ta eşzamanlı şarkı sözlerini OSDLyrics'e gönderir.",
    },
    lyricsBackground: {
    ...
    closePrompt: {
      title: 'YesPlayMusic kapatılsın mı?',
      description: 'Tepside çalmaya devam etmeyi veya çıkmayı seçin.',
