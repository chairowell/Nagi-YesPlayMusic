...
<p align="center">
  <img src="images/tui-now-playing.png" alt="ypm 终端版：正在播放" width="880">
</p>
...
会把新歌歌词覆盖成上一首的老问题。
=======
**Anon 进度条。** 在原有的彩虹猫之外多加了一种进度条皮肤，设置里可以切换，三者互斥。

**Creeper 进度条。** Minecraft 苦力怕风格的进度条皮肤，设置里可以切换，与其他皮肤互斥。
>>>>>>> 8a00f08 (✨ feat: 新增 Creeper 苦力怕进度条皮肤)
